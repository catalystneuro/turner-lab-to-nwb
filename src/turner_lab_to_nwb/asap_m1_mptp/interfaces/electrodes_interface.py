...
# Atlas files are not part of the package. They default to <project_root>/data, which only exists in a
# checkout; set TURNER_LAB_DATA_DIR to point an installed package (or CI) at them.
_DATA_ROOT = Path(os.environ.get("TURNER_LAB_DATA_DIR", _PROJECT_ROOT / "data"))
...
_D99_ATLAS_DIR = _DATA_ROOT / "d99_atlas" / "D99_v2.0_dist"
...
_RHEMAP_WARP_PATH = _DATA_ROOT / "rhemap_warps" / "NMTv2.0-sym_to_D99_CompositeWarp.nii.gz"
...
_MEBRAINS_WARP_PATH = _DATA_ROOT / "rhemap_warps" / "MEBRAINS_to_D99_CompositeWarp.nii.gz"
...
_MEBRAINS_ATLAS_DIR = _DATA_ROOT / "mebrains"
...
# Resolved from the package, not the project root, so it is found when the package is installed
...
_CHARM_ATLAS_PATH = (
    _DATA_ROOT / "nmt_v2" / "NMT_v2.0_sym" / "NMT_v2.0_sym"
    / "supplemental_CHARM" / "CHARM_4_in_NMT_v2.0_sym.nii.gz"
)
_CHARM_KEY_PATH = (
    _DATA_ROOT / "nmt_v2" / "NMT_v2.0_sym"
